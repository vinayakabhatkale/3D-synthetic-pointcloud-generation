...
class ScannerProperties(PropertyGroup):
    ...
    exportNPY: BoolProperty(
        name="Export .npy file",
        description="Enable or disable if data should be saved into .npy file format",
        default = False
    )
...
def modifyAndScan(context, dependencies_installed, properties, objectName):
    ...
    if properties.enableModification:
        ...
        return generic.startScan(context, dependencies_installed, properties, objectName)
...
def performScan(context, dependencies_installed, properties):
    ...
    if properties.enableSwapping:
        ...
        for (currentFile, fileName) in filePaths:
            ...
            return modifyAndScan(context, dependencies_installed, properties, fileName)
    else:
        return modifyAndScan(context, dependencies_installed, properties, None)
...
def scan_rotating(context, 
        ...
        exportLAS, exportHDF, exportCSV, exportNPY, exportSingleFrames,
    ...
    properties.exportNPY = exportNPY
...
class OBJECT_PT_EXPORT_PANEL(MAIN_PANEL, Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(properties, "exportNPY")
