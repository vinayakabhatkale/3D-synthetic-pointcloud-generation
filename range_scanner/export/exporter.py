...
class Exporter:
    ...
    def exportNPY(self, fileNameExtra=""):
        from . import export_np 
        export_np.export(self.filePath, self.rawFileName + fileNameExtra, self.mappedData, self.exportNoiseData)
