...
def performScan(context, 
    ...
    for x in xRange:
        ...
        for y in yRange:
            ...
            if closestHit is not None: 
                ...
                #print('hello from my own code')
                closestHit.categoryID = closestHit.target["categoryID"]
    ...
    if len(slicedScannedValues) > 0:
        ...
        if exportLAS or exportHDF or exportCSV or exportSegmentedImage or exportRenderedImage or exportDepthmap or exportNPY:
