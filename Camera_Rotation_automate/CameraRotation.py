...
target_object = bpy.data.objects.get("Cube")  # Replace with your object's name
...
if camera_obj is not None and target_object is not None:
    ...
    for i in range(num_steps + 1):
        ...
        camera_location = target_object.location + Vector((-10 * math.cos(rotation_step * i), -10 * math.sin(rotation_step * i), 0))
